using UnityEngine;
    ...
    public class SecurityCamera : MonoBehaviour
    {
        ...
        void FixedUpdate()
        {
            ...
            float kp = 0.6f, kd = 0.1f; // small, stable defaults
        ...
        void Update()
        {
            ...
            if (Physics.SphereCast(eye, sweepRadius, dir, out RaycastHit hit, dist, playerMask, QueryTriggerInteraction.Ignore)
